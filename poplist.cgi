...
if check_logged_in():
	...
	if pname not in rec['wishlist']:
		
		print """<script>document.location="failed3.php";</script>"""
	else:	
		db.users.update_one({'username':username},{'$pull':{"wishlist":pname}})
		print """<script>document.location="wishlist.cgi";</script>"""


else:
	print"""<center><p>Please log in for update your server wishlist</p></center>"""
	print"""<center><a href="home.cgi"><button style="width:auto;">Go back to home page</button></a></center>"""