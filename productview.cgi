...
if check_admin():
  print """<li style="float:right"><a class="active" href="admin/usrmanage.cgi">Manage</a></li>"""
...
<li style="float:right"><a id="change" href="product.cgi">All products</a></li>
</ul>"""
fs=cgi.FieldStorage()
tag=fs.getfirst('tag')
allproduct=db.products.find({"tag":tag})
for products in allproduct:
	print """<a href="view.cgi?pid="""+products['pid']+"""\"><img src=\""""+products['pimg']+"""\" id="image2" class="imgcontainer" width="200" height="280"></a>""" 
